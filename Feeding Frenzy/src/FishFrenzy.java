...
class FishFrenzy extends World {
  ...
  */
  ...
  public WorldScene score(WorldScene acc) {
    return acc.placeImageXY(new TextImage(Integer.toString(this.player.size), 30, Color.BLACK),
        1600, 50);
  }
...
class PlayerFish extends AFish {
  ...
  */
  ...
  public PlayerFish grow(AFish eatenFish) {
    return new PlayerFish(0, this.posy, this.color, this.size += eatenFish.size / 2,
...
class ExamplesAnimation {
  ...
  boolean testDraw(Tester t) {
    return t.checkExpect(this.f1.draw(this.ws),
        ...
        && t.checkExpect(lof1.draw(this.ws), ws.placeImageXY(new EllipseImage(60, 30,
            OutlineMode.SOLID, Color.RED), 0, 130));
  }
  ...
  boolean testGrow(Tester t) {
    return t.checkExpect(this.playerTest.grow(f3),
        new PlayerFish(0, 500, Color.BLUE, 25, 30, true));
  }
  
  boolean testShrink(Tester t) {
    return t.checkExpect(this.playerTest.shrink(f3), 
        new PlayerFish(0, 500, Color.BLUE, 0, 30, true));
  }
  
  boolean testOnTick(Tester t) {
    return t.checkExpect(this.worldWithFish.onTickTest(), 
        new FishFrenzy(1000, 1000, player, lof13, rand))
        && t.checkExpect(this.initWorld.onTickTest(), 
            new FishFrenzy(1000, 1000, player, lof0, rand));
  }
  ...
  boolean testMove(Tester t) {   
    return t.checkExpect(f10.move(), new BackgroundFish(496, 500, Color.RED, 10, 4, false))
        && t.checkExpect(playerTest.move("right"), 
            new PlayerFish(530, 500, Color.BLUE, 20, 30, true));
  ...
  boolean testMoveFish(Tester t) {
    return t.checkExpect(lof15.moveFish(), new ConsLoFish(
        new BackgroundFish(496, 500, Color.RED, 10, 4, false), mt))
